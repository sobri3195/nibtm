...
const translations = {
  en: {
    ...
    hero: { badge: 'Biomedical Learning Platform', title: 'Advance biomedical skills with structured AI-ready learning.', description: 'NiBTM 7.0 unifies bioinformatics, translational AI, research datasets, and expert mentoring into one premium learning workflow.', identityNote: 'Official styling: NiBTM uses a lowercase i for immunology and the micro philosophy, plus an uppercase T because Technology is the dominant platform layer.', trustBadges: ['Trusted by 12+ biomedical labs', 'Industry-aligned curriculum', 'Mentor-guided outcomes'] },
    sections: {
      about: { badge: 'About NiBTM 7.0', title: 'From foundation to clinical translation in one connected learning system.', description: 'Build scientific confidence first, operationalize AI workflows second, and deliver clinically meaningful impact third.' },
    ...
    features: [
      ['Adaptive Learning Intelligence', 'Core Engine', 'NiBTM 7.0 personalizes module order and difficulty based on mastery and performance data.'],
    ...
    footer: { description: 'Premium biomedical learning platform for data, AI, and clinical translation.', platform: ['Learning Paths', 'Topics', 'Datasets', 'Mentoring'], resources: ['Documentation', 'Research Notes', 'Community', 'FAQ'], contact: ['hello@nibtm7.ai', '+62 812-0000-000', 'Jakarta, Indonesia'] },
  ...
  id: {
    ...
    footer: { description: 'Platform pembelajaran biomedis premium untuk data, AI, dan translasi klinis.', platform: ['Jalur Belajar', 'Topik', 'Dataset', 'Mentoring'], resources: ['Dokumentasi', 'Catatan Riset', 'Komunitas', 'FAQ'], contact: ['hello@nibtm7.ai', '+62 812-0000-000', 'Jakarta, Indonesia'] },
...
translations.zh = makeVariant('zh', {
  ...
  hero: { badge: '生物医学学习平台', title: '通过结构化、AI 就绪的学习提升生物医学能力。', description: 'NiBTM 7.0 将生物信息学、转化 AI、研究数据集和专家指导整合为一个高级学习流程。', identityNote: '官方写法：NiBTM 中的小写 i 代表 immunology 与微观哲学，大写 T 强调 Technology 是平台的主导层。', trustBadges: ['12+ 生物医学实验室信赖', '贴合行业的课程', '导师指导成果'] },
  sections: { about: { badge: '关于 NiBTM 7.0', title: '从基础到临床转化，尽在一个互联学习系统。', description: '先建立科学信心，再运行 AI 工作流，最终实现有意义的临床影响。' }, features: { badge: '平台功能', title: '面向生物医学专业人士的高级学习体验。' }, paths: { badge: '学习路径', title: '适合每个生物医学职业阶段的行动路径。' }, topics: { badge: '主题', title: '按领域、级别和数据可用性探索模块。' }, datasets: { badge: '数据集', title: '研究级数据集，健康状态和格式清晰。' }, mentors: { badge: '导师', title: '与经验丰富的生物医学研究者和实践者一起学习。' } },
  ...
  features: [['自适应学习智能', '核心引擎', 'NiBTM 7.0 根据掌握度和表现数据个性化模块顺序与难度。'], ['生物医学沙盒实验室', '实践', '开展基因组、信号、影像和转化工作流实验。'], ['临床就绪案例模拟', '练习', '通过贴近临床和研究现实的决策检查点进行训练。'], ['研究作品集构建器', '职业', '将项目整理为面向深造、实验室或行业的循证作品集。'], ['导师反馈闭环', '导师制', '接受生物医学专家的结构化评审，提升严谨性与表达。'], ['进度分析', '洞察', '用结果导向分析和技能差距建议跟踪能力成长。']],
  tabs: ['初级', '中级', '高级', '认证'],
...
translations.ar = makeVariant('ar', {
  ...
  hero: { badge: 'منصة تعلم الطب الحيوي', title: 'طوّر مهارات الطب الحيوي بتعلم منظم وجاهز للذكاء الاصطناعي.', description: 'تجمع NiBTM 7.0 المعلوماتية الحيوية والذكاء الاصطناعي الانتقالي وبيانات البحث وإرشاد الخبراء في مسار تعلم واحد.', identityNote: 'الصياغة الرسمية: تستخدم NiBTM حرف i صغيراً للدلالة على immunology والفلسفة الميكروية، وحرف T كبيراً لأن Technology هي الطبقة المهيمنة في المنصة.', trustBadges: ['موثوقة لدى أكثر من 12 مختبراً', 'منهج متوافق مع الصناعة', 'نتائج بإرشاد الخبراء'] },
  sections: { about: { badge: 'حول NiBTM 7.0', title: 'من الأساسيات إلى الترجمة السريرية في نظام تعلم مترابط.', description: 'ابنِ الثقة العلمية، ثم شغّل سير عمل الذكاء الاصطناعي، ثم قدّم أثراً سريرياً ملموساً.' }, features: { badge: 'ميزات المنصة', title: 'تجربة تعلم متميزة لمحترفي الطب الحيوي.' }, paths: { badge: 'مسارات التعلم', title: 'مسارات عملية لكل مرحلة مهنية في الطب الحيوي.' }, topics: { badge: 'الموضوعات', title: 'استكشف الوحدات حسب المجال والمستوى وتوفر البيانات.' }, datasets: { badge: 'مجموعات البيانات', title: 'بيانات بحثية بحالة صحية وتنسيق واضحين.' }, mentors: { badge: 'المرشدون', title: 'تعلّم مع باحثين وممارسين ذوي خبرة في الطب الحيوي.' } },
