...
const translations = {
  en: {
    ...
    hero: { badge: 'Biomedical Learning Platform', title: 'Advance biomedical skills with structured AI-ready learning.', description: 'NiBTM 7.0 unifies bioinformatics, translational AI, research datasets, and expert mentoring into one premium learning workflow.', trustBadges: ['Trusted by 12+ biomedical labs', 'Industry-aligned curriculum', 'Mentor-guided outcomes'] },
    sections: {
  ...
  id: {
    ...
    hero: { badge: 'Platform Pembelajaran Biomedis', title: 'Tingkatkan keterampilan biomedis dengan pembelajaran terstruktur siap AI.', description: 'NiBTM 7.0 menyatukan bioinformatika, AI translasi, dataset riset, dan mentoring pakar dalam satu alur belajar premium.', trustBadges: ['Dipercaya 12+ laboratorium biomedis', 'Kurikulum selaras industri', 'Hasil dipandu mentor'] },
...
translations.zh = makeVariant('zh', {
  ...
  hero: { badge: '生物医学学习平台', title: '通过结构化、AI 就绪的学习提升生物医学能力。', description: 'NiBTM 7.0 将生物信息学、转化 AI、研究数据集和专家指导整合为一个高级学习流程。', trustBadges: ['12+ 生物医学实验室信赖', '贴合行业的课程', '导师指导成果'] },
